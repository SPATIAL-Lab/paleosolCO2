...
plot.jpi(ai, post.clp$BUGSoutput$sims.list$DIFC, n = 100)
lines(ai, post.clp$BUGSoutput$median$DIFC, col="red", lwd = 5)
plot.jpi(ai, post.clp$BUGSoutput$sims.list$R_PCQ_S_0, n = 100, ylim = c(0, 1e-12))
lines(ai, post.clp$BUGSoutput$median$R_PCQ_S_0, col="red", lwd = 5)
