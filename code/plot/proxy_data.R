...
png("figure/fuxian_proxy_records.png", width = 4.5, height = 5.5, units = "in", res = 500)
par(mar = c(4, 4, 4, 4))
...
points(d13c.rs[, 1], d13c.rs[, 2], col = "black", bg = pal[1], pch = 21, cex = 1.3)
...
points(d18c.rs[, 1], d18c.rs[,2], col = "black", bg = pal[3], pch = 21, cex = 1.3)
...
points(d13o.rs[, 1], d13o.rs[, 2], col = "black", bg = pal[2], pch = 21, cex = 1.3)
...
points(MS.rs[, 1], MS.rs[, 2], col = "black", bg = pal[1], pch = 21, cex = 1.3)
